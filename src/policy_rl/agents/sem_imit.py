...
from ..envs.habitat.imit_env import Seman_Imit_Env
...
class Sem_Imit_Env_Agent(Seman_Imit_Env):
    """The Sem_Curiosity environment agent class. A separate Sem_Imit_Env_Agent class
