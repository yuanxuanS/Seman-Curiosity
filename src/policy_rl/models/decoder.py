...
from .nn.graph.attention import LogitAttention
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        **logit_attn_kwargs,
        ...
        self.use_graph_context = use_graph_context      # TODO?
    ...
    def _precompute_cache(
        ...
        if self.use_graph_context:      # TODO
    ...
    def _get_log_p(
        ...
        # td_unbatch = unbatchify(td, num_starts)     # TODO: 和sample-based有点类似？
        ...
        # Compute logits: glimpse_q是context embedding计算得到,logit_k是node embedding计算得到
