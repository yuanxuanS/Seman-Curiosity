...
def main(cfg):
    specify_pkl_pth="/home/users/wpp/Semantic-Curiosity/Semantic-Curiosity/samples_vsqf_v1_3_eval.pkl"
    # "/home/users/wpp/Semantic-Curiosity/Semantic-Curiosity/samples_vsqf_v1_eval_re.pkl"
    specify_num= 6936
    ...
    for id_iteration in range(cfg.n_iterations):
        ...
        if "use_gt" in cfg.training and cfg.training.use_gt:    # TODO?
            dm = GTDataModule(specify_pkl_pth,
                              specify_num,
                              pipeline.pseudo_labeler, dataset_path, 
