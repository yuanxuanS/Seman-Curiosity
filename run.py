...
import asample
from asample.config.default import get_config
...
def run_exp(exp_name: str, exp_config: str, 
    ...
    config.freeze()
    # log_dir = "outputs_asample/models/{}/".format(exp_name)
    dump_dir = "outputs_asample/dump/{}/".format(exp_name)
    ...
    logger.add_filehandler('outputs_asample/logs/'+config.LOG_FILE)
