...
from habitat_baselines.utils.common import CategoricalNet, get_num_actions, GaussianNet
...
# vlfm
class PolicyV2(abc.ABC):
# class PolicyV2(nn.Module, metaclass=abc.ABCMeta):
...
class NetPolicy(nn.Module, PolicyV2):
