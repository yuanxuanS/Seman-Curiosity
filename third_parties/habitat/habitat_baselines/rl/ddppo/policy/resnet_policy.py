...
from habitat_baselines.utils.common import CategoricalNet, get_num_actions
if TYPE_CHECKING:
...
class PointNavResNetNet2(Net):
    ...
    def __init__(
        ...
        for uuid in [
            ...
            if uuid in observation_space.spaces:
                ...
                goal_visual_encoder = ResNetEncoder2(
                    goal_observation_space,
                    baseplanes=resnet_baseplanes,
                    ngroups=resnet_baseplanes // 2,
                    make_backbone=getattr(resnet, backbone),
        ...
        self.visual_encoder = ResNetEncoder2(
            use_obs_space,
            baseplanes=resnet_baseplanes,
            ngroups=resnet_baseplanes // 2,
            make_backbone=getattr(resnet, backbone),
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            if (  # noqa: SIM401
                PointNavResNetNet2.PRETRAINED_VISUAL_FEATURES_KEY
                in observations
            ):
...
@baseline_registry.register_policy
class PointNavResNetPolicyV2(NetPolicy):
    def __init__(
        self,
        observation_space: spaces.Dict,
        action_space,
        ...
        **kwargs,
        ...
        ins_pnresnet = PointNavResNetNet2(
                observation_space=observation_space,
