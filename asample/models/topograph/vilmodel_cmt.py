...
from asample.common.ops import create_transformer_encoder
from asample.common.ops import extend_neg_masks, gen_seq_masks, pad_tensors_wgrad
...
class GlocalTextPathNavCMT(BertPreTrainedModel):
    ...
    def forward_navigation(
        ...
        gmap_embeds = self.global_encoder.encoder(
            gmap_embeds, gmap_masks, gmap_embeds, gmap_masks,
            graph_sprels=graph_sprels
        )
        return gmap_embeds
