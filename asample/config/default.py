...
# -----------------------------------------------------------------------------
_C = CN()
_C.BASE_TASK_CONFIG_PATH = "habitat_extensions/config/sample_gibson.yaml"
_C.TASK_CONFIG = CN()  # task_config will be stored as a config node
_C.TRAINER_NAME = "asample"
_C.ENV_NAME = "ActiveSampleEnv"
_C.SIMULATOR_GPU_IDS = [0]
_C.VIDEO_OPTION = []  # options: "disk", "tensorboard"
_C.VIDEO_DIR = "videos/debug"
_C.TENSORBOARD_DIR = "outputs_asample/tensorboard_dirs/debug"
_C.IMG_DIR = "outputs_asample/imgs/"
_C.RESULTS_DIR = "outputs_asample/checkpoints/pretrained/evals"
...
_C.MODEL.DEPTH_ENCODER.cnn_type = "ResnetDepthEncoder"
...
_C.MODEL.DEPTH_ENCODER.ddppo_checkpoint = (
    "data_scene/ddppo-models/gibson-2plus-resnet50.pth"
)
